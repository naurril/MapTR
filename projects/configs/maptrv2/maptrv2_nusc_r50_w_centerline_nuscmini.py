"""
MapTRv2-R50 nuScenes+centerline pretrained config for nuScenes-mini inference.

Uses the nuScenes+centerline checkpoint (54.3 mAP on nuScenes val).
nuScenes images are 1600×900; scale=0.5 maps them to 800×450,
matching the nuScenes training resolution.
"""
_base_ = [
...
# nuScenes images are 1600×900; scale=0.5 → 800×450 (matches training resolution)
