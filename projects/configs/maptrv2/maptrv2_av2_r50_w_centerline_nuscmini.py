"""
MapTRv2-R50 Argoverse2+centerline pretrained config for nuScenes-mini inference.

Uses the AV2-pretrained checkpoint with centerline support (61.3 mAP).
AV2 was trained with 7 ring cameras; num_cams=7 is kept to match checkpoint.
The extra cams_embed row is never applied in the LSSTransform path.

AV2 images were 2048×2048 at scale 0.3 → 614×614.
nuScenes-mini images are 1920×1080; scale 0.3 → 576×324.
"""
_base_ = [
