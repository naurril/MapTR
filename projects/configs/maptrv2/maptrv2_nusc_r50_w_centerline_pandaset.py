"""
MapTRv2-R50 nuScenes+centerline pretrained config for PandaSet inference.

Uses the nuScenes-pretrained checkpoint with centerline support (54.3 mAP).
PandaSet images are 1920×1080; scale=800/1920 maps them to 800×450,
...
# PandaSet cameras are 1920×1080. Scale 800/1920 ≈ 0.4167 → 800×450,
# matching the nuScenes training resolution (1600×900 × 0.5 = 800×450).
_img_scale_factor = 800 / 1920
