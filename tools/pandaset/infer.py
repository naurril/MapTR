...
def main():
    ...
    # PyTorch ≥ 2.6 defaults weights_only=True; old checkpoints need False.
    # Monkey-patch torch.load so that calls from mmengine use weights_only=False.
    ...
    for frame_idx, data in enumerate(data_loader):
        ...
        pts_local = res['pts_3d'].numpy()[..., :2]                 # (N, P, 2) — drop z for 3D models
